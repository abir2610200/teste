...
import {  Add,CheckCircle, Delete, FilterList, ArrowDownward, ArrowUpward, Print, FileDownload } from "@mui/icons-material";
import axios from "axios";

import jsPDF from "jspdf";
import "jspdf-autotable";
import AddEditCompte from "./Adddepot";
              ...
              .map((compte) => (
                ...
                >
                  ...
                  <TableCell sx={{ width: { xs: "25%", sm: "20%" }, textAlign: "center" }}>
                    <IconButton color="primary" onClick={() => handleValid(compte._id)}>
                      <CheckCircle />
                    </IconButton>
